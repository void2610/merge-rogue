...
/// </summary>
public class SafeAllAttackByTenCoin : SafeRelicBase
{
    protected override void RegisterEffects()
    {
        ...
        RegisterPlayerAttackModifier(
            ...
            (original, current) =>
            {
                ...
                // コイン消費（賢者の石がない場合のみ）
                if (!HasRelicCondition<SafeNoConsumeCoinDuringBattle>()())
                {
    ...
    private bool CanConvertAttackCondition()
    {
        ...
        var hasNoConsumeCoin = HasRelicCondition<SafeNoConsumeCoinDuringBattle>()();
