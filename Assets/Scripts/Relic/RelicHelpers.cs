...
public static class RelicHelpers
{
    ...
    {
        EventManager.RegisterCoinGainModifier(relic, ValueProcessors.Multiply(multiplier), condition);
    }
    ...
    {
        EventManager.RegisterCoinGainModifier(relic, ValueProcessors.Add(amount), condition);
    }
    ...
    {
        EventManager.RegisterCoinConsumeModifier(relic, modifier, condition);
    }
    ...
    {
        EventManager.RegisterCoinConsumeModifier(relic, ValueProcessors.SetZero(), condition);
    }
    ...
    {
        EventManager.RegisterPlayerAttackModifier(relic, modifier, condition);
    }
    ...
    {
        EventManager.RegisterPlayerAttackModifier(relic, attack => attack + amount, condition);
    }
    ...
    {
        EventManager.RegisterPlayerAttackModifier(relic, attack => (int)(attack * multiplier), condition);
    }
    ...
    {
        EventManager.RegisterPlayerDamageModifier(relic, modifier, condition);
    }
